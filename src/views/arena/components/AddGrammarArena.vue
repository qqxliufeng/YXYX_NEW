    ...
    >
      ...
      >
        ...
        <el-form-item label="题目数量">
          <el-col :span="20">
            <el-input-number
              v-model="arenaModel.practicePassNum"
              :min="1"
              :style="{width: '100%'}"
              :max="200"
            />
...
export default {
    ...
    randomWordModel() {
      return {
        ...
        data: {
          ...
          wordCount: this.arenaModel.practicePassNum,
  ...
  watch: {
    'arenaModel.textBookId'(newVal) {
      ...
      this.arenaModel.practicePassNum = 20
  ...
  methods: {
    ...
    getTextBookList() {
      this.$http({
        url: this.isOnLineSchool ? this.$urlPath.queryGrammarTextBookList : this.$urlPath.querySchoolAndTextBook,
    ...
    submitArena() {
      ...
      postData.practicePassNum = this.arenaModel.practicePassNum
